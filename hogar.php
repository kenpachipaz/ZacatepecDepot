...
<div id="fondo">
 ...
 <div id = "menu">
    <div class="lavalamp" >
      <ul class="desplegable">
	  	...
	  	<li><a href="electronica.pho">Electrónica</a>	
	 	<li><a href="#">Hogar</a>	
	      </ul>
	  </li>
 ...
 <h1 style="color:#BF1301; text-align:center;">Hogar</h1>  
 <?php         
       include("acceso.php");
        ...
        while($row = mysql_fetch_array($consulta)) {
		  ...
		  <table width='100%'>
              <tr>
                ...
                <td rowspan="6"><img src='<?php echo $row['imagen'];?>' width="180" height="110"></td>
              </tr>
              <tr>
                <td>Categoría:</td>
          ...
          <?php } ?>
<!--<div id="img1"><img src="Imagenes/depHog01.jpg" width="145" height="105"></div>
 <div id="img2"><img src="Imagenes/depHog02.jpg" width="145" height="105"></div>
 <div id="img3"><img src="Imagenes/depHog03.jpg" width="205" height="120"></div>
 <div id="img4"><img src="Imagenes/depHog04.jpg" width="210" height="120"></div>-->
 </div>
 <br>
</div>
<div class ="pie">
