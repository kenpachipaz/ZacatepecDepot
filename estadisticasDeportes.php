...
if($_SESSION['tipo']!="gerente deportes"){
session_start();
...
<title>Gerente de Deportes</title>
...
<div id="fondo">
 ...
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='1' and fecha BETWEEN '2014-01-01' and '2014-01-31'");
 $enero=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='1' and fecha BETWEEN '2014-02-01' and '2014-02-29'");
 $febrero=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='1' and fecha BETWEEN '2014-03-01' and '2014-03-31'");
 $marzo=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='1' and fecha BETWEEN '2014-04-01' and '2014-04-30'");
 $abril=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='1' and fecha BETWEEN '2014-05-01' and '2014-05-31'");
 $mayo=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='1' and fecha BETWEEN '2014-06-01' and '2014-06-30'");
...
<div id="categoria" style="display: none">
  <?php
   include("acceso.php");
 mysql_query("SET NAMES 'UTF8'");
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=1 and P.Categoria='Zapatos' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Zapatos=$row[0];
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=1 and P.Categoria='Ropa' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Ropa=$row[0];
 echo $Ropa;
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=1 and P.Categoria='Balones' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Balones=$row[0];
...
<div id="marca" style="display:none">
   ...
   include("acceso.php");
 mysql_query("SET NAMES 'UTF8'");
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=1 and P.Marca='Nike' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Nike=$row[0];
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=1 and P.Marca='Puma' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Puma=$row[0];
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=1 and P.Marca='Adidas' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Adidas=$row[0];
