 ...
 <div id = "menu">
    <div class="lavalamp" >
      <ul class="desplegable">
          <li><a href="bienvenidoJesus.php">Bienvenida</a></li>
          <li><a href="estadisticaElectronica.php">Estadísticas</a></li>     
          <li><a href="cerrarSesion.php">Cerrar Sesión</a></li>
      </ul>      
    </div>
    <h1 style="color:blue;">Consulta de Productos Existentes en el Departamento de Electrónica</h1>
  </div>
