...
<div id="fondo">
 ...
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='2' and fecha BETWEEN '2014-01-01' and '2014-01-31'");
 $enero=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='2' and fecha BETWEEN '2014-02-01' and '2014-02-29'");
 $febrero=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='2' and fecha BETWEEN '2014-03-01' and '2014-03-31'");
 $marzo=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='2' and fecha BETWEEN '2014-04-01' and '2014-04-30'");
 $abril=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='2' and fecha BETWEEN '2014-05-01' and '2014-05-31'");
 $mayo=mysql_num_rows($consulta);
 $consulta = mysql_query("SELECT * FROM  ventas where idDepartamento='2' and fecha BETWEEN '2014-06-01' and '2014-06-30'");
...
<div id="categoria" style="display: none">
  <?php
   include("acceso.php");
 mysql_query("SET NAMES 'UTF8'");
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=2 and P.Categoria='Muebles' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Muebles=$row[0];
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=2 and P.Categoria='Cristalería' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Cristaleria=$row[0];
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=2 and P.Categoria='Aires acondicionados' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Aires_acondicionados=$row[0];
...
<div id="marca" style="display:none">
   ...
   include("acceso.php");
 mysql_query("SET NAMES 'UTF8'");
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=2 and P.Marca='Jamocha' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Jamocha=$row[0];
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=2 and P.Marca='Violanti' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Violanti=$row[0];
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=2 and P.Marca='Samsung' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Samsung=$row[0];
 $consulta = mysql_query("SELECT SUM(V.cantidad) from ventas V INNER JOIN Producto P where V.idDepartamento=2 and P.Marca='Luminac Grand' and V.IdProducto=P.IdProducto");
 $row = mysql_fetch_array($consulta);
 $Luminac_grand=$row[0];
...
// Ciclo que imprime cada una de las barras   
 ...
 $ancho = 600;
 $alto = 300; 
 $valores=array('Jamocha'=>$Jamocha, 
                'Violanti'=>$Violanti,
                'Samsung'=>$Samsung,
                'Luminac Grand'=>$Luminac_grand,
               );
